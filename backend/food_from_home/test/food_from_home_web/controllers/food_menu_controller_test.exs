defmodule FoodFromHomeWeb.FoodMenuControllerTest do
  ...
  describe "show" do
    ...
    test "renders food menu when a menu for a given menu_id exists", %{conn: conn, food_menu: food_menu} do
    ...
    test "renders errors when a menu for a given menu_id does not exist", %{conn: conn, food_menu: food_menu} do
  ...
  describe "lists food menus" do
    setup do
      ...
      valid_attrs_2 = %{description: "some another description", allergens: ["gluten"], ingredients: ["butter", "milk", "wheat flour"], menu_illustration: "some another menu_illustration", name: "some another name", preparation_time_in_minutes: 25, price: 6.5, valid_until: ~U[2023-11-12 14:28:00Z]}
      food_menu_2 = FoodMenuRepoFixtures.food_menu_fixture(valid_attrs_2, seller_2.id)

      valid_attrs_3 = %{description: "some another new description", allergens: [], ingredients: ["butter", "onion"], menu_illustration: "some another new menu_illustration", name: "some another new name", preparation_time_in_minutes: 30, price: 9.25, valid_until: ~U[2100-05-06 14:28:00Z]}
    ...
    test "lists all food menus", %{conn: conn, food_menu_1: food_menu_1, food_menu_2: food_menu_2, food_menu_3: food_menu_3} do
    ...
    test "lists food menus for a given seller id", %{conn: conn, food_menu_2: food_menu_2, food_menu_3: food_menu_3} do
    ...
    test "lists active food menus for a given seller id", %{conn: conn, food_menu_2: food_menu_2, food_menu_3: food_menu_3} do
