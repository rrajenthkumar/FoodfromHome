defmodule FoodFromHome.GoogleGeocoding do
  ...
  def get_position(address = %Address{}) do
    ...
    position_request_url = "#{@google_geocoding_api_url}?address=#{address_string}&key=#{@google_geocoding_api_key}"
  ...
  defp address_to_string(%Address{door_number: door_number, street: street, city: city, country: country, postal_code: postal_code}) do
